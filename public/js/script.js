...
// write a function that will allow a user reset their password
// const user = {
  // email: 'ruthboatengs1@gmail.com',
  // password: '1234'
// }
...
// for any iteraton if student is present then increase total present by 1;
...
// classes in javascript (made an exception to start with capital letters, the rest are all camel casing - this one is called pascal)
class Laptop {
constructor() {
this.brand = brand;
this.color = color;
